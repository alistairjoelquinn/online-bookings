const About = () => (
    <section className="h-2/5 max-w-6xl overflow-scroll px-4 pb-0 text-left md:mt-16 md:pb-20 lg:max-w-xl">
        ...
        <p className="para">
            There is nothing I love more than helping people to reach their goals with confidence. I know that learning
            a language can sometimes be stressful, and it can be difficult to stay motivated, so I aim to make it as fun
            and stress-free as possible.
        </p>
        <p className="para">
            I teach CEFR levels A2-C1, using a textbook, combined with other materials to help consolidate grammar in a
            simple, fun, and understandable way. These classes involve a good amount of conversation, to practice
            producing what you&apos;ve learnt, and reach a greater level of fluency more quickly. I will also provide
            written homework exercises for writing practice.
        </p>
        <p className="para">
            ...
            conversation prompt questions. If you have a particular area of interest, I&apos;m happy to create a list of
            questions specific to this topic.
        </p>
    </section>
);
