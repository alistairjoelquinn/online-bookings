...
export default function Home() {
  return (
    <div className="max-w-6xl animate-reveal px-4 pt-5 pb-0 text-left md:pt-16 md:pb-20 lg:max-w-xl">
      ...
      <p className="para">
        Hi, I&apos;m Felicity. I&apos;m an English teacher from Scotland, currently based in Berlin, Germany. I&apos;m
        passionate about helping people from all over the world reach their language learning goals smiling.
      </p>
