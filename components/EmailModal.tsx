...
const EmailModal = ({ setShowEmailModal }: Props) => {
    ...
    return (
        <>
            ...
            <div className="fixed left-1/2 top-1/2 z-40 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-lg border-2 border-purple-400 bg-white px-8 py-10 opacity-100 sm:px-16 md:px-20">
